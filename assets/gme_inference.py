    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.base = AutoModel.from_pretrained(
            model_name, torch_dtype=torch.float16, trust_remote_code=True, **kwargs
        )
        self.base.eval()
        self.normalize = True
        self.device = device
        ...
        self.processor = AutoProcessor.from_pretrained(
            model_name, min_pixels=min_pixels, max_pixels=max_pixels, trust_remote_code=True, **kwargs
        )

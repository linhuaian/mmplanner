...
\end{tabular}}
% \caption{Ablation study on the components in TCA.  `SD' denotes the diveristy between segments of the same action, `FD' denotes the diversity between the frames within the same segment, and `TC' denotes the temporal coherence of the segments. Optimal results are obtained when considering both diversity and temporal coherence. Gray row indicates the final setup used in this paper.}
